...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', type=int, default=60, help="number of epochs. (default 60)")
    parser.add_argument('--stage', type=str, default='train', help='running stage. train, test or all. (default train)')
